...
import { selectSearchText, setSearchText } from '../meal-item-sample/store/mealIteamSampleSlice';

function MealItemSampleHeader() {
...
export default MealItemSampleHeader;
