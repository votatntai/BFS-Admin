...
import { createMealItemSample, saveMealItemSample } from '../store/mealItemSampleDetailSlice';
...
export default function CageDetailHeader(prop) {
    ...
    function handleSaveProduct() {
        //     dispatch(saveMealItemSample(getValues().id, ));
        navigate('/master-data/MealItemSample');
    }
    ...
    const handleAdd = () => {
        ...
        dispatch(createMealItemSample(formData));
        navigate('/master-data/MealItemSample');
    }
    return (<>
