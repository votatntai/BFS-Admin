...
import { menuSampleReducerState, getMenuSampleData, setPaginPageNumber, setSearchText } from './slice/menuSampleSlice';
...
const UnitHeader = ()=>{
    ...
    const handleSearch= async()=>{
        ...
        await dispatch(getMenuSampleData({name: searchValue, pageNumber: 0, pageSize: pageSize}))
    ...
    >
        <Typography className="text-24 md:text-32 font-extrabold tracking-tight">Menu samples</Typography>
    </motion.span>
