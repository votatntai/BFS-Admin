...
import { caremodeReducerState, getCaremodeData,setSearchText } from './slice/caremodeSlice';
...
const AreaHeader = ()=>{
    ...
    >
        <Typography className="text-24 md:text-32 font-extrabold tracking-tight">Care modes</Typography>
    </motion.span>
